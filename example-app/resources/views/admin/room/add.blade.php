...
@section('room_add')
    <div class="container-fluid">
        <form action="{{route('route_room_add')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="id_vitri" id="exampleInputPassword1">
            </div>
            <div class="mb-3">
                <label class="form-label">ID_LoaiPhong</label>
                <input type="text" class="form-control" name="id_loaiphong" id="exampleInputPassword1">
            </div>
            <div class="mb-3">
