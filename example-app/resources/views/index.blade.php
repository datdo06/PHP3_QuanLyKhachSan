                ...
                <div class="row gx-0 bg-white d-none d-lg-flex">
                    <div class="col-lg-7 px-5 text-start">
                        <div class="h-100 d-inline-flex align-items-center py-2 me-4">
                            ...
                            <p class="mb-0">tiendatdo24@gmail.com</p>
                        </div>
                        <div class="h-100 d-inline-flex align-items-center py-2">
                            <i class="fa fa-phone-alt text-primary me-2"></i>
                            <p class="mb-0">0358402509</p>
                        </div>
                    </div>
...
{{--                @foreach($banner as $bn)--}}
                <div class="carousel-item">
                    <img class="w-100" src="https://bold.vn/wp-content/uploads/2019/05/bold-academy-5.jpg"alt="Image">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="room-item shadow rounded overflow-hidden">
                        <div class="position-relative">
                            <img class="img-fluid" src="{{ $rm -> image ? '' . Storage::url($rm -> image) : ''}}" alt="">
                            <small class="position-absolute start-0 top-100 translate-middle-y bg-primary text-white rounded py-1 px-3 ms-4">{{$rm -> price}}</small>
                        </div>
                        <div class="p-4 mt-2">
                            <div class="d-flex justify-content-between mb-3">
                                <h5 class="mb-0">{{$rm -> name}}</h5>
                                <div class="ps-2">
                            ...
                            <div class="d-flex mb-3">
                                <small class="border-end me-3 pe-3"><i class="fa fa-bed text-primary me-2"></i>{{$rm -> id_loaiphong}}</small>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="rounded shadow overflow-hidden">
                        <div class="position-relative">
                            <img class="img-fluid" src="{{ $ac -> image ? '' . Storage::url($ac -> image) : ''}}" alt="">
                        ...
                        <div class="text-center p-4 mt-3">
                            <h5 class="fw-bold mb-0">{{$ac -> name}}</h5>
                            <small>{{$ac -> address}}</small>
                        </div>
                    </div>
                </div>
                @endforeach
